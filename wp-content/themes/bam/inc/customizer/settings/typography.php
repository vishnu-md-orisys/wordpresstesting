        ...
        public function elements() {
            ...
            return apply_filters( 'bam_typography_elements', array (
                ...
                'headings'  => array(
                    ...
                    'target'    => 'h1, h2, h3, h4, h5, h6, .site-title, .bam-entry .entry-title a, .widget-title, .is-style-bam-widget-title, .entry-title, .related-section-title, .related-post-title a, .single .entry-title, .archive .page-title',
                    'defaults'  => array(
                ...
                'widget_title'  => array(
                    ...
                    'target'    => '.widget-title, .is-style-bam-widget-title',
                    'defaults'  => array(
                        'font-size'     => array(
                            'desktop'   => '21px'
                        ),
